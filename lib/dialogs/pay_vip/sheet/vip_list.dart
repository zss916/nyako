...
/*
  Widget vipItem2(
      int index, PayQuickCommodite item, List<PayQuickCommodite> data) {
    return GestureDetector(
      onTap: () {
        setState(() {
          select(index, data);
          PayQuickCommodite item = data.firstWhere((e) => (e.isSelect == true));
          // toQVipPayChannel(item, createPath: widget.path ?? "");
          toQuickVIPPayChannel(item, createPath: widget.path ?? "");
        });
      },
      child: Stack(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: BorderRadiusDirectional.circular(14),
                border: Border.all(color: const Color(0xB3F447FF), width: 1)),
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Expanded(
                  ...
                  child: Column(
                    children: [
                      const Spacer(),
                      AutoSizeText(
                        Tr.app_str_day.trArgs([(item.vipDays ?? 0).toString()]),
                        textAlign: TextAlign.center,
                        maxFontSize: 20,
                        minFontSize: 8,
                        softWrap: true,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              PointUtils.instance.toRenewPointC(
                  explain: "${(widget.path ?? "")}${widget.selectIndex}");

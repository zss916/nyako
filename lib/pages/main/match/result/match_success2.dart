...
class MatchSuccess2 extends StatefulWidget {
  final HostMatchLimitEntityAnchor anchor;
  final Function? onRestart;

  final MatchLogic? logic;

  const MatchSuccess2(this.anchor, {super.key, this.onRestart, this.logic});

  @override
  State<MatchSuccess2> createState() => _BuildBodyState();
}

class _BuildBodyState extends State<MatchSuccess2> {
